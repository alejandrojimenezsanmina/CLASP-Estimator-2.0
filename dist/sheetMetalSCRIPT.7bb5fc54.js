...
function transformData(data) {
  ...
  var _loop = function _loop(i) {
    data.forEach(function (row) {
      ...
      } : row["Parameter / Part"] === "Own Hardware quantity" ? rowObj["User added hardware"]["Qty"] = Object.values(row)[i] : row["Parameter / Part"] === "Own Hdw description" ? rowObj["User added hardware"]["Description"] = Object.values(row)[i] : row["Parameter / Part"] === "Own Hdw price" ? rowObj["User added hardware"]["Price"] = Object.values(row)[i] : null;
    });
