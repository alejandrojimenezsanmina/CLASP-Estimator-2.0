...
uploadFileForm.addEventListener('submit', function (e) {
  e.preventDefault();
  e.stopPropagation();
  loloaderRight.style.display = 'block';
  ...
  fileReader.onload = function (e) {
    ...
    console.log(jsonData, googleSheetURL, sheet);
    google.script.run.withSuccessHandler(unhideSegmet).withFailureHandler(FailedToLoad).estimate(jsonData, googleSheetURL, "Sheet Metal");
  };
});

function unhideSegmet() {
  uploadFileForm.style.display = 'block';
  loloaderRight.style.display = 'none';
}
