...
function transformData(data) {
  ...
  var _loop = function _loop(i) {
    data.forEach(function (row) {
      ...
      } : row["Parameter / Part"] === "Own Hardware quantity" ? rowObj["User added hardware"]["Qty"] = Object.values(row)[i] || 0 : row["Parameter / Part"] === "Own Hdw description" ? rowObj["User added hardware"]["Description"] = Object.values(row)[i] || 0 : row["Parameter / Part"] === "Own Hdw price" ? rowObj["User added hardware"]["Price"] = Object.values(row)[i] || 0 : row["Parameter / Part"] === "Hardware description" ? rowObj["Hdw complexity"] = row["Part" + index + 1] || 0 : row["Parameter / Part"] === "Hardware quantity" ? rowObj["Hardware qty"] = row["Part" + index + 1] || 0 : null;
    });
