...
uploadFileForm.addEventListener('submit', function (e) {
  ...
  fileReader.onload = function (e) {
    ...
    console.log(jsonData, googleSheet, sheet);
    google.script.run.withSuccessHandler(unhideSegmet).withFailureHandler(FailedToLoad).estimate(jsonData, googleSheet, "Sheet Metal");
  };
});
