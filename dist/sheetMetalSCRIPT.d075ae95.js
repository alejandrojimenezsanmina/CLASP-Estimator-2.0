...
function transformData(data) {
  ...
  var _loop = function _loop(i) {
    data.forEach(function (row) {
      row["Element"] === "Part Number" ? rowObj["Part Number"] = Object.values(row)[i] : row["Element"] === "EAU" ? rowObj["EAU"] = Object.values(row)[i] : row["Element"] === "Units(mm/in)" ? rowObj["Units(mm/in)"] = Object.values(row)[i] : row["Element"] === "Material" ? rowObj["Material"] = Object.values(row)[i] : row["Element"] === "Length" ? rowObj["Length"] = Object.values(row)[i] : row["Element"] === "Width" ? rowObj["Width"] = Object.values(row)[i] : row["Element"] === "Thickness" ? rowObj["Thickness"] = Object.values(row)[i] : row["Element"] === "Finish Type" ? rowObj["Finish Type"] = Object.values(row)[i] : row["Element"] === "Finish Type 2" ? rowObj["Finish Type 2"] = Object.values(row)[i] : row["Element"] === "Hardware qty" ? rowObj["Hardware qty"] = Object.values(row)[i] : row["Element"] === "Hdw complexity" ? rowObj["Hdw complexity"] = Object.values(row)[i] : row["Element"] === "Assembly" ? rowObj.operations["Assembly"] = {
        "Assembly count": Object.values(row)[i]
      } : row["Element"] === "Bend" ? rowObj.operations["Bend"] = {
        "Bend count": Object.values(row)[i]
      } : row["Element"] === "Punch" ? rowObj.operations["Punch"] = {
        "Punch count": Object.values(row)[i]
      } : row["Element"] === "Stamp" ? rowObj.operations["Stamp"] = {
        "Stamp count": Object.values(row)[i]
      } : row["Element"] === "Aluminum weld" ? rowObj.operations["Aluminum weld"] = {
        "Aluminum weld count": Object.values(row)[i]
      } : row["Element"] === "SS/Steel weld" ? rowObj.operations["SS/Steel weld"] = {
        "SS/Steel weld count": Object.values(row)[i]
      } : row["Element"] === "Threaded hole" ? rowObj.operations["Threaded hole"] = {
        "Threaded hole count": Object.values(row)[i]
      } : row["Element"] === "Countersunk hole" ? rowObj.operations["Countersunk hole"] = {
        "Countersunk hole count": Object.values(row)[i]
      } : row["Element"] === "Own Hardware quantity" ? rowObj["User added hardware"]["Qty"] = Object.values(row)[i] : row["Element"] === "Own Hdw description" ? rowObj["User added hardware"]["Description"] = Object.values(row)[i] : row["Element"] === "Own Hdw price" ? rowObj["User added hardware"]["Price"] = Object.values(row)[i] : null;
    });
...
function getNumberOfParts(data) {
  ...
  data.forEach(function (element, index) {
    if (element["Element"] === "Part Number") {
